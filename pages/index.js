...
export default function Home() {
  return (
    <>
      ...
      <main >
        <div>
          <img src="/hero.jpg" alt="" className='object-cover  object-centerw-screen ' style={{ width: "100vw", height: "60vh" }} />
        </div>
        <section className="text-gray-600 body-font">
          <div className="container px-5 pt-10 mx-auto">
            <div className="flex flex-wrap w-full mb-10 flex-col items-center text-center">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Lets wear the code</h1>
              <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wear the code? then try lets wear, wear whatever you want whenever you want</p>
            </div>
