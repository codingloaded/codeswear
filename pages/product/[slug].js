...
export default function Slug({cart, addTocart, removeFromcart, clearcart, subTotal}) {
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-10 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto px-20 py-5 object-cover object-top rounded md:shadow-lg" src="https://m.media-amazon.com/images/I/71hhaL6CM8L._SY741_.jpg"/>
              <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="flex">
                  ...
                  <button onClick={()=>{addTocart(slug, 1, 499, "lets ecom", "xl",'red')}} className="flex ml-10 text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">Add to cart</button>
